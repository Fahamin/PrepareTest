...
public class DatabaseSalesHelper extends SQLiteOpenHelper {
    public static String DATABASE_NAME = "sealsDatabase";
    public static Integer VERSTION = 3;
    public static String TABLE_NAME = "total_sales";
    ...
    public DatabaseSalesHelper(Context context) {
